    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dislikes', models.ManyToManyField(related_name='dislikes', to='board.Person')),
                ('editor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='edit_articles', to='board.person')),
                ('likes', models.ManyToManyField(related_name='likes', to='board.Person')),
                ('scraps', models.ManyToManyField(related_name='scraps', to='board.Person')),
            ],
        ),
    ]
